...
public class FastqcTotalSeq2 {

	public static void main(String[] args) {
		// TODO Auto-generated method stub
		String inFolder = args[0];
		String fileOut = args[1];
		int postSample = Integer.parseInt(args[2]); 
		String filename;
...
//				printTotalSeqsCleaned(filename,outFile);
	...
	public static void printTotalSeqs(String filePath, PrintWriter outFile, int posSam) throws IOException {
		// TODO Auto-generated method stub
